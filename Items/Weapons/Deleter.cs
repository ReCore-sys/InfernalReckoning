...
namespace InfernalReckoning.Items.Weapons
{
    public class Deleter : ModItem
    {
        ...
        {
            Tooltip.SetDefault("If you can get this gun, you are already cheating");
        }

        public override void SetDefaults()
        {
            item.damage = 2000; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Veerium>(), 10);
